...
from hmanet.inference.predict import predict_from_folder
from hmanet.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
...
def main():
    ...
    # parser.add_argument('-chk', default='model_best')
    parser.add_argument('-chk', default='model_final_checkpoint')


    parser.add_argument("-i", '--input_folder', default="../../DATASET/hmanet_raw/hmanet_raw_data/Task002_Synapse/imagesTs")


    parser.add_argument('-o', "--output_folder", default="../../DATASET/hmanet_raw/hmanet_raw_data/Task002_Synapse/inferTs/hmanetTrainerV2_hmanet_synapse")
    ...
    parser.add_argument('-tr', '--trainer_class_name',
                        help='Name of the hmanetTrainer used for 2D U-Net, full resolution 3D U-Net and low resolution '
    ...
    parser.add_argument('-z', '--save_npz', required=False, action='store_true',
                        help="use this if you want to ensemble these predictions with those of other models. Softmax "
                             ...
                             "merged between output_folders with hmanet_ensemble_predictions")
