...
def copy_npz_fom_valsets():
    ...
    folders = ['hmanetTrainerNewCandidate23_FabiansPreActResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23_FabiansResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23__hmanetPlans']
    for f in folders:
...
def ensemble(experiments=('hmanetTrainerNewCandidate23_FabiansPreActResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23_FabiansResNet__hmanetPlans'), out_dir="/media/fabian/Results/hmanet/3d_lowres/Task048_KiTS_clean/ensemble_preactres_and_res"):
    from hmanet.inference.ensemble_predictions import merge
...
def prepare_submission(fld= "/home/fabian/drives/datasets/results/hmanet/test_sets/Task048_KiTS_clean/predicted_ens_3d_fullres_3d_cascade_fullres_postprocessed", # '/home/fabian/datasets_fabian/predicted_KiTS_hmanetTrainerNewCandidate23_FabiansResNet',
                       out='/home/fabian/drives/datasets/results/hmanet/test_sets/Task048_KiTS_clean/submission'):
...
def pretent_to_be_hmanetTrainer(base, folds=(0, 1, 2, 3, 4)):
    """
    changes best checkpoint pickle hmanettrainer class name to hmanetTrainer
    :param experiments:
    :return:
    """
    for fold in folds:
...
def hmanetTrainer_these(experiments=('hmanetTrainerNewCandidate23_FabiansPreActResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23_FabiansResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23__hmanetPlans')):
    """
    changes best checkpoint pickle hmanettrainer class name to hmanetTrainer
    ...
    for exp in experiments:
        cur = join(base, exp)
        pretent_to_be_hmanetTrainer(cur)


def reset_trainerName_these(experiments=('hmanetTrainerNewCandidate23_FabiansPreActResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23_FabiansResNet__hmanetPlans',
               'hmanetTrainerNewCandidate23__hmanetPlans')):
    """
    changes best checkpoint pickle hmanettrainer class name to hmanetTrainer
...
if __name__ == "__main__":
    ...
    out = "/media/fabian/My Book/MedicalDecathlon/hmanet_raw_splitted/Task040_KiTS"
    ...
    json_dict['reference'] = "KiTS data for hmanet"
    json_dict['licence'] = ""
