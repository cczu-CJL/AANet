...
if __name__ == "__main__":
    ...
    output_raw = join(hmanet_raw_data, full_taskname)
    shutil.rmtree(output_raw)
    shutil.copytree(join(hmanet_raw_data, 'Task999_Fluo-N2DH-SIM_thickborder'), output_raw)

    shutil.rmtree(join(hmanet_raw_data, 'Task999_Fluo-N2DH-SIM_thickborder'))
