...
from hmanet.paths import preprocessing_output_dir, hmanet_raw_data
from hmanet.utilities.sitk_stuff import copy_geometry
...
def convert_variant2_predicted_test_to_submission_format(folder_with_predictions,
                                                         output_folder="/home/fabian/drives/datasets/results/hmanet/test_sets/Task038_CHAOS_Task_3_5_Variant2/ready_to_submit",
                                                         postprocessing_file="/home/fabian/drives/datasets/results/hmanet/ensembles/Task038_CHAOS_Task_3_5_Variant2/ensemble_2d__hmanetTrainerV2__hmanetPlansv2.1--3d_fullres__hmanetTrainerV2__hmanetPlansv2.1/postprocessing.json"):
    """
    ...
    :return:
    """
    postprocessing_file = "/media/fabian/Results/hmanet/3d_fullres/Task039_CHAOS_Task_3_5_Variant2_highres/" \
                          "hmanetTrainerV2__hmanetPlansfixed/postprocessing.json"
    ...
    from hmanet.postprocessing.connected_components import apply_postprocessing_to_folder, load_postprocessing
