...
import argparse
from hmanet.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(hmanet.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "hmanet.training.network_training")
