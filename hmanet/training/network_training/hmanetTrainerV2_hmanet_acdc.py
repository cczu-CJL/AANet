...
from hmanet.network_architecture.hmanet_acdc import hmanet as hmanet

    
class hmanetTrainerV2_hmanet_acdc(hmanetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network=hmanet(crop_size=self.crop_size,
