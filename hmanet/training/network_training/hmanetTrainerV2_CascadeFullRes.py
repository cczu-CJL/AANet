...
from hmanet.training.network_training.hmanetTrainerV2 import hmanetTrainerV2
...
class hmanetTrainerV2CascadeFullRes(hmanetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="hmanetTrainerV2", fp16=False):
