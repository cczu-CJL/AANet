...
from hmanet.training.network_training.network_trainer import NetworkTrainer
...
class hmanetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from nnFormhmaneterTrainer and the init args change then you need to redefine self.init_args
        in your init accordingly. Otherwise checkpoints won't load properly!
        """
        super(hmanetTrainer, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(hmanetTrainer, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(hmanetTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
