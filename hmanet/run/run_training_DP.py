...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, hmanetTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "hmanetTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, hmanetTrainer), "network_trainer was found but is not derived from " \
                                                         "hmanetTrainer"
