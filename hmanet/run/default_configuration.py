...
from hmanet.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier


from batchgenerators.utilities.file_and_folder_operations import *
from hmanet.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(hmanet.__path__[0], "training", "network_training"),
                              base_module='hmanet.training.network_training'):
    ...
    if task=='Task001_ACDC':
        ...
        plans['plans_per_stage'][Stage]['patch_size']=np.array([64,128,128])  # ph 48, 192, 192  hmanet 64,128,128
        # plans['plans_per_stage'][Stage]['patch_size']=np.array([48, 192, 192])  # 48, 192, 192
    ...
    print("###############################################")
    print("I am running the following hmanet: %s" % network)
