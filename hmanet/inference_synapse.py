...
def test(fold):
    # path='./'
    path='../DATASET/hmanet_raw/hmanet_raw_data/Task002_Synapse/'
    ...
    print(os.path.join(path,'labelsTs'))
    print("label_list:", label_list)

    print("infer_list:", infer_list)
    print(os.path.join(path,'inferTs',fold))
    print(infer_list)
