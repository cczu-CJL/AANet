...
from hmanet.experiment_planning.utils import split_4d, crop, analyze_dataset, plan_and_preprocess
...
if __name__ == "__main__":
    ...
    if task == "all":
        all_tasks = subdirs(hmanet_raw_data, prefix="Task", join=False)
        for t in all_tasks:
        ...
        if not use_splitted or not isdir(join(hmanet_raw_data, task)):
