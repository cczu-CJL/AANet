...
from hmanet.experiment_planning.utils import split_4d
from hmanet.utilities.file_endings import remove_trailing_slash
...
def main():
    ...
    # parser.add_argument("-i", help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
    #                                "website", default="../../DATASET/hmanet_raw/hmanet_raw_data/Task02_Synapse")
