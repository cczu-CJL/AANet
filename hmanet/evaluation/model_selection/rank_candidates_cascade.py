...
if __name__ == "__main__":
    ...
    plans = "hmanetPlansv2.1"

    overwrite_plans = {
        'hmanetTrainerCascadeFullRes': ['hmanetPlans'],
    }

    trainers = [
        'hmanetTrainerCascadeFullRes',
        'hmanetTrainerV2CascadeFullRes_EducatedGuess',
        'hmanetTrainerV2CascadeFullRes_EducatedGuess2',
        'hmanetTrainerV2CascadeFullRes_EducatedGuess3',
        'hmanetTrainerV2CascadeFullRes_lowerLR',
        'hmanetTrainerV2CascadeFullRes',
        'hmanetTrainerV2CascadeFullRes_noConnComp',
        'hmanetTrainerV2CascadeFullRes_shorter_lowerLR',
        'hmanetTrainerV2CascadeFullRes_shorter',
        'hmanetTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
