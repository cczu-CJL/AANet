...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'hmanetTrainerV2_2': ["hmanetPlans", "hmanetPlans_customClip"], # r
        'hmanetTrainerV2_2_noMirror': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_lessMomentum_noMirror': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_2_structSeg_noMirror': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_2_structSeg': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_lessMomentum_noMirror_structSeg': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_FabiansResUNet_structSet_NoMirror': ["hmanetPlans", "hmanetPlans_customClip"],  # r
        'hmanetTrainerV2_FabiansResUNet_structSet': ["hmanetPlans", "hmanetPlans_customClip"],  # r

    }

    trainers = ['hmanetTrainer'] + [
        'hmanetTrainerV2_2',
        'hmanetTrainerV2_lessMomentum_noMirror',
        'hmanetTrainerV2_2_noMirror',
        'hmanetTrainerV2_2_structSeg_noMirror',
        'hmanetTrainerV2_2_structSeg',
        'hmanetTrainerV2_lessMomentum_noMirror_structSeg',
        'hmanetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'hmanetTrainerV2_FabiansResUNet_structSet_NoMirror',
        'hmanetTrainerV2_FabiansResUNet_structSet',
    ]
